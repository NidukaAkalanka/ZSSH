...
pre_req()
{
	...
	apt update -y && apt upgrade -y
        ...
        apt-get install -y dropbear && sudo apt install ufw -y && apt-get install -y stunnel4 && apt-get install -y squid && apt-get install -y cmake && apt-get install -y python3 && apt-get install -y screenfetch && apt-get install -y openssl
        ufw allow 443/tcp
	ufw allow 444/tcp
        ufw allow 22/tcp
        ufw allow 80/tcp
...
<font>┊┊┊┊ <b><font color="#ff5079">&nbsp;~NIDUKA AKALANKA~</font></b></font><br>
<font>┊┊┊✧ </font><br>
...
<font color="#008080">&nbsp;Your Privacy is our #Number_One</font></font><br>
<b>&nbsp;Powered by <font color="#ff5079">~ZSSH~</font></b><br>
<br>
EOF
